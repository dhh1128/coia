...
Appendix A used to define a template per language plus a page of per-language rules. It now
...
only per-language datum. Appendix A.3 lists everything that deleted.

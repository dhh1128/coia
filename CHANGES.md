...
three that dissented did not agree with each other. [Appendix A.2](APPENDIX-A.md) carries the evidence and
...
*New digits* — `4` unfit, `5` second-hand, `7` do-not-use, `8` retired. See [Appendix D](APPENDIX-D.md).
...
*[Appendix A](APPENDIX-A.md) is normative for generators.* As "recommended", two conforming
...
Normative golden vectors ([Appendix C](APPENDIX-C.md)). Normative character tables ([Appendix B](APPENDIX-B.md)).
